...
There seems to be a tri-modal distribution, with Staten Island producing the least amount of trash with the fewest number of rat sightings, Manhattan and the Bronx in the mid-range, and Queens and Brooklyn producing both the most trash and having the most rat sightings.
...
While there is not much information on sub-categories of refuse, it's possible that the three clusters seen in this graph correlate with the tri-modal distribution from the previous visualization. The three clusters also appear to have increasing trends, with higher rat counts being slightly associated with higher total tons of refuse. MGP (metal, glass, plastic) and paper trash on the other hand do not seem to be associated with rat count as there is no defined distribution or trend. 
