...
* How are sociodemographic factors, weather conditions, trash density, and restaurant inspections related to rat sightings?
...
More information about the data tidying process is found [here](data-sources.html).

## [Exploratory analysis](exploratory.html)
As stated earlier, the questions we had for our project evolved as we worked to join and analyze data. Here are some select summaries and visualizations of our data (more can be found in the exploratory analysis [page](exploratory.html)).
...
## [Additional analysis](statistical.html)

```{r}
# not sure if we did any tbh, but could put the two linear models of the rat sightings here, though the conclusion is very weak
